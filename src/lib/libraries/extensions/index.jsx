...
const menuItems = [
    ...
    },
    {
        ...
        description: (
            <FormattedMessage
                ...
                description="The description for the AltMod Camera extension."
    ...
    },
    {
        ...
        tags: ['penguinmod', 'datamgmt'],
        description: 'Store data after AltMod has already been closed out. Basic Server Storage is also included.',
    ...
    },
    {
        ...
        tags: ['penguinmod'],
        description: 'Fetch information from the AltMod API.',
    ...
    },
    {
        name: (
            <FormattedMessage
                defaultMessage="AltMod Extra Extensions"
...
if (IsLocal || IsLiveTests) {
    const extras = [
        ...
        {
            name: 'AltMod Permissions',
            extensionId: 'JgPermissionBlocks',
            iconURL: jgPermissionExtensionIcon,
            tags: ['penguinmod'],
            description: 'Legacy extension, old blocks no longer serve a real purpose. Direct blocks to manage permissions that AltMod requires you have to do certain tasks.',
            featured: true
        },
        {
