...
const Credits = () => (
    <main className={styles.main}>
        ...
        <section>
            <h2>Thank you</h2>
            <p>
                Without TurboWarp and PenguinMod, AltMod may have never existed.
            ...
            <h2>Contributors</h2>
            <p>
                AltMod is made by a small bunch of developers.
            ...
            <p>There are even community members who have helped develop AltMod. People like <i>you!</i></p>
            <UserList users={UserData.pmPullRequestDevelopers} />
            <p><i>The list order is randomized on each refresh.</i></p>
            <p>
                We've also included work from other open-source projects inside of AltMod.
        ...
        <section>
            <h2>GitHub Pages</h2>
            <p>We currently use <a href="https://pages.github.com/">GitHub Pages</a> to host AltMod.</p>
            ...
            <h2>Server Host</h2>
            <p>
                AltMod's Project Sharing server is currently hosted by <a href="https://github.com/ianyourgod">ianyourgod</a>.
                <br></br>
            ...
            <p>
                The AltMod Server API is maintained by many people.
            ...
            <h2>Costumes</h2>
            <p>
                All AltMod costumes are downloaded or created from:
                <ul>
                    <li><a href="https://publicdomainvectors.org/">https://publicdomainvectors.org/</a></li>
                    <li><a href="https://discord.gg/NZ9MBMYTZh">User-submissions from the AltMod Discord Server</a></li>
                    <li>The AltMod Developers</li>
                </ul>
                All costumes exclusive to AltMod are included under Public Domain licenses or licenses such as MIT and CC0.
            </p>
            ...
            <h2>Sound Effects</h2>
            <p>
                All AltMod sounds are downloaded or created from:
                <ul>
                ...
                All sounds exclusive to AltMod are included under Public Domain licenses or licenses such as MIT and CC0.
            </p>
            ...
            <h2>Accounts</h2>
            <p>
                Scratch login on AltMod is managed with <a href="https://oauth2.scratch-wiki.info/">ScratchOAuth2</a>,
        ...
        <section>
            <h1>AltMod & TurboWarp</h1>
        </section>
        <section>
            <h2>Extensions</h2>
            <p><i>
                If you are an extension developer who wants their extension removed from AltMod's extensions list,
            ...
            <p><i>The list order is randomized on each refresh.</i></p>
            <p>
                AltMod also has a few people who made and submitted extensions too!
        ...
        <section>
            ...
            <p><i>The list order is randomized on each refresh.</i></p>
            <p>AltMod-exclusive addons are created by the contributors listed in the Contributors section.</p>
        </section>
        <section>
            <h1>TurboWarp</h1>
        </section>
        ...
        <section>
            ...
            <p>
                AltMod is also (very very slowly) getting translated into other languages, in the future
                hopefully the same number of languages can be supported. It'll take a while until we get there though.
            </p>
            <p>Here is the current list of AltMod Translators:</p>
