        ...
        <div className={styles.footerContent}>
            <div className={styles.footerText}>
                <FormattedMessage
                    ...
                    defaultMessage="AltMod and TurboWarp are not affiliated with Scratch, the Scratch Team, or the Scratch Foundation."
                    description="Disclaimer that AltMod and TurboWarp are not connected to Scratch"
...
class Interface extends React.Component {
    ...
    handleUpdateProjectTitle(title, isDefault) {
        if (isDefault || !title) {
            document.title = `AltMod - ${this.props.intl.formatMessage(messages.defaultTitle)}`;
        } else {
            document.title = `${title} - AltMod`;
        }
    }
    copyProjectLink(id) {
